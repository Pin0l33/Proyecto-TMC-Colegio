...
public class Dialogo : MonoBehaviour
{
    ...
    private void StartDialogue()
    {
        ...
        MovimientoJugador.canMove = false; // 🔥 BLOQUEAR MOVIMIENTO
    ...
    private void ShowOptions()
    {
        ...
        isChoosing = true;
        MovimientoJugador.canMove = false; // 🔥 ASEGURAR BLOQUEO

        dialoguePanel.SetActive(false); // 🔥 OCULTAR DIÁLOGO
    ...
    private void EndDialogue()
    {
        ...
        MovimientoJugador.canMove = true; // 🔥 DEVOLVER CONTROL
    }
